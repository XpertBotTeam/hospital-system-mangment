                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item" href="{{route('treatment-history',$pharmacist->id)}}"><i class="fa fa-clock"></i>Treatment History</a>
                                        <a href="{{route('pharmacists.show',$pharmacist->id)}}" class="dropdown-item"><i
