                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item" href="{{route('treatment-history',$receptionist->id)}}"><i class="fa fa-clock"></i>Treatment History</a>
                                        <a href="{{route('receptionists.show',$receptionist->id)}}" class="dropdown-item"><i
